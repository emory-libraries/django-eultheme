...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'eultheme_banner', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        # Adding field 'Banner.show_on_date'
        db.add_column(u'eultheme_banner', 'show_on_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'eultheme_banner', 'disabled')
        db.delete_column(u'eultheme_banner', 'show_on_date')
